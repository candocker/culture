...
class EpubService extends AbstractService
{
    ...
    public function renderBook($data)
    {
       ...
       $this->book->setLanguage("en"); // Not needed, but included for the example, Language is mandatory, but EPub defaults to "en". Use RFC3066 Language codes, such as "en", "da", "fr" etc.
       ...
       $this->book->setPublisher("John and Jane Doe Publications", "http://JohnJaneDoePublications.com/"); // I hope this is a non existent address :)
       $this->book->setDate(time()); // Strictly not needed as the book date defaults to time().
       $this->book->setRights("Copyright and licence information specific for the book."); // As this is generated, this _could_ contain the name or licence information of the user who purchased the book, if needed. If this is used that way, the identifier must also be made unique for the book.
       $this->book->setSourceURL("http://JohnJaneDoePublications.com/books/TestBook.html");
       
       $this->book->addDublinCoreMetadata(DublinCore::CONTRIBUTOR, "PHP");
       
       $this->book->setSubject("Test book");
       $this->book->setSubject("keywords");
       $this->book->setSubject("Chapter levels");
    }

    public function renderMeta($data)
    {
       // Insert custom meta data to the book, in this case, Calibre series index information.
       CalibreHelper::setCalibreMetadata($this->book, "PHPePub Test books", "1");
       
       $this->log->logLine("Set up parameters");
       
       $cssData = "body {\n  margin-left: .5em;\n  margin-right: .5em;\n  text-align: justify;\n}\n\np {\n  font-family: serif;\n  font-size: 10pt;\n  text-align: justify;\n  text-indent: 1em;\n  margin-top: 0px;\n  margin-bottom: 1ex;\n}\n\nh1, h2 {\n  font-family: sans-serif;\n  font-style: italic;\n  text-align: center;\n  background-color: #6b879c;\n  color: white;\n  width: 100%;\n}\n\nh1 {\n    margin-bottom: 2px;\n}\n\nh2 {\n    margin-top: -2px;\n    margin-bottom: 2px;\n}\n";
       
       $this->log->logLine("Add css");
       $this->book->addCSSFile("styles.css", "css1", $cssData);
       ...
       /* $this->book->setCoverImage("/absolute/path/to/demo/cover-image.jpg"); */
       
       // setCoverImage can only be called once per book, but can be called at any point in the book creation.
       $this->log->logLine("Set Cover Image");
       
       $cover = $this->contentStart . "<h1>Test Book</h1>\n<h2>By: John Doe Johnson</h2>\n" . $this->bookEnd;
       $this->book->addChapter("Notices", "Cover.html", $cover);
       $this->book->buildTOC(NULL, "toc", "Table of Contents", TRUE, TRUE);
       ...
       $this->book->addFileToMETAINF("com.apple.ibooks.display-options.xml", "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<display_options>\n    <platform name=\"*\">\n        <option name=\"fixed-layout\">true</option>\n        <option name=\"interactive\">true</option>\n        <option name=\"specified-fonts\">true</option>\n    </platform>\n</display_options>");
       
       // add a custom metadata to use on the MetaValue entries.
       // Using DublinCore as an example, even if it is automatically included.
       $this->book->addCustomNamespace("dc", "http://purl.org/dc/elements/1.1/"); // StaticData::$namespaces["dc"]);
       // This is to show how to use meta data, normally you'd use the $this->book->setAuthor
       ...
       $this->book->addCustomMetaValue($metaValue);
    }

    public function renderChapters($chapters)
    {
       
       $chapter1 = $this->contentStart . "<h1>Chapter 1</h1>\n"
           . "<h2>Lorem ipsum</h2>\n"
       ...
       $chapter3 = array();
       $chapter3[] = $this->contentStart . "<h1>Chapter 3</h1>\n"
           ...
           . "<p>In hac habitasse platea dictumst. Integer lectus augue, varius nec rutrum non, fringilla eu neque. Curabitur a gravida velit. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.
       ...
       $chapter4 = $this->contentStart . "<h1>Chapter 4</h1>\n"
           . "<h2>Vivamus bibendum massa</h2>\n"
       ...
       $chapter5 = $this->contentStart . "<h1>Chapter 5</h1>\n"
       ...
       $this->log->logLine("Build Chapters");
       
       $this->log->logLine("Add Chapter 1");
       $this->book->addChapter("Chapter 1: Lorem ipsum", "Chapter001.html", $chapter1, true, EPub::EXTERNAL_REF_ADD);
       
       $this->log->logLine("Add Chapter 2");
       $this->book->addChapter("Chapter 2: Vivamus bibendum massa", "Chapter002.html", $this->contentStart . "<h1>Chapter 2</h1>\n" . $chapter2);
       ...
       $this->log->logLine("Add referenced image from Chapter 2");
       $this->book->addLargeFile("demo/DemoInlineImage.jpg", "DemoInlineImage", "/data/htmlwww/laravel-system/vendor/grandt/phpepub/tests/demo/DemoInlineImage.jpg", "image/jpeg");
       $this->book->setSplitSize(250000);
       return ;
       
       $this->log->logLine("Add Chapter 3");
       $this->book->addChapter("Chapter 3: Vivamus bibendum massa again", "Chapter003.html", $chapter3);
       
       // Auto split a chapter:
       $this->log->logLine("Add Chapter 4");
       $this->book->setSplitSize(15000); // For this test, we split at approx 15k. Default is 250000 had we left it alone.
       $this->book->addChapter("Chapter 4: Vivamus bibendum massa split", "Chapter004.html", $chapter4, true);
       
       $this->book->subLevel();
       $this->book->addChapter("Chapter 4B: test inlined chapter", "Chapter004.html#sub01");
       $this->book->backLevel();
       ...
       $this->log->logLine("new EPubChapterSplitter()");
       ...
       $this->log->logLine("Split chapter 5");
       ...
       while (list($k, $v) = each($html2)) {
           ...
           $this->book->addChapter(trim($cName), "Chapter005_" . $idx . ".html", $v, true);
       }
       ...
       // $this->book->addChapter("Chapter 6: External Image test", "Chapter006.html", $chapter1, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       //$this->log->logLine("add chapter 6");
       
       $this->log->logLine("Add Chapter 6");
       $this->book->addChapter("Chapter 6: Local Image test", "Chapter006.html", $this->contentStart . "<h1>Chapter 6</h1>\n" . $chapter2, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       
       
       // Chapter 7 tests level indentation
       $chapter7Body = "<p>Vivamus bibendum massa ac magna congue gravida. Curabitur nulla ante, accumsan sit amet luctus a, fermentum ut diam. Maecenas porttitor faucibus mattis. Ut auctor aliquet ligula nec posuere. Nullam arcu turpis, dapibus sit amet tempor nec, cursus at augue. Aliquam sed sem velit, id sagittis mauris. Donec sed ipsum nisi, id scelerisque felis. Cras lacus est, fermentum in ultricies eu, congue in elit. Nulla tincidunt posuere eros, eget suscipit tellus porta vel. Aliquam ut sollicitudin libero. Suspendisse potenti. Sed cursus dignissim nulla in elementum. Aliquam id quam justo, sit amet laoreet ligula. Etiam pellentesque tellus a nisi commodo eu sodales ante commodo. Vestibulum ultricies sapien arcu. Proin nunc mauris, ultrices id imperdiet ac, malesuada ac nunc. Nunc a mi quis nunc ultricies rhoncus. Mauris pellentesque eros eu augue congue ac tincidunt est gravida.</p>\n" . $this->bookEnd;
       
       $this->log->logLine("Add Chapter 7.0.0.0");
       $this->book->addChapter("Chapter 7", "Chapter00700.html", $this->contentStart . "<h2>Chapter 7.0.0</h2>\n" . $chapter7Body, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       
       
       $this->log->logLine("Add Chapter 7.1.0.0");
       $this->book->subLevel();
       $this->book->addChapter("Chapter 7.1", "Chapter00710.html", $this->contentStart . "<h2>Chapter 7.1.0</h2>\n" . $chapter7Body, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       
       
       $this->log->logLine("Add Chapter 7.1.1.0");
       $this->book->subLevel();
       $this->book->addChapter("Chapter 7.1.1", "Chapter00711.html", $this->contentStart . "<h2>Chapter 7.1.1</h2>\n" . $chapter7Body, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       
       $this->log->logLine("Add Chapter 7.1.1.1");
       $this->book->subLevel();
       $this->book->addChapter("Chapter 7.1.1.1", "Chapter007111.html", $this->contentStart . "<h2>Chapter 7.1.1.1</h2>\n" . $chapter7Body, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       $this->book->addChapter("Chapter 7.1.1.2", "Chapter007112.html", $this->contentStart . "<h2>Chapter 7.1.1.2</h2>\n" . $chapter7Body, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       
       $this->log->logLine("Add Chapter 7.1.2.0");
       $this->book->backLevel();
       $this->book->addChapter("Chapter 7.1.2", "Chapter007120.html", $this->contentStart . "<h2>Chapter 7.1.2.0</h2>\n" . $chapter7Body, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       
       $this->log->logLine("Add Chapter 7.1.3.0");
       $this->book->addChapter("Chapter 7.1.3", "Chapter007130.html", $this->contentStart . "<h2>Chapter 7.1.3.0</h2>\n" . $chapter7Body, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       
       $this->log->logLine("Add Chapter 7.1.3.x");
       $this->book->subLevel();
       $this->book->addChapter("Chapter 7.1.3.1", "Chapter007131.html", $this->contentStart . "<h2>Chapter 7.1.3.1</h2>\n" . $chapter7Body, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       $this->book->addChapter("Chapter 7.1.3.2", "Chapter007132.html", $this->contentStart . "<h2>Chapter 7.1.3.2</h2>\n" . $chapter7Body, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       $this->book->addChapter("Chapter 7.1.3.3", "Chapter007133.html", $this->contentStart . "<h2>Chapter 7.1.3.3</h2>\n" . $chapter7Body, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       $this->book->addChapter("Chapter 7.1.3.4", "Chapter007134.html", $this->contentStart . "<h2>Chapter 7.1.3.4</h2>\n" . $chapter7Body, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       
       
       $this->log->logLine("Add Chapter 7.2.0.0");
       ...
       $this->book->setCurrentLevel(2);
       $this->book->addChapter("Chapter 7.2", "Chapter00720.html", $this->contentStart . "<h2>Chapter 7.2.0</h2>\n" . $chapter7Body, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       
       
       $this->log->logLine("Add Chapter 7.3.0.0");
       $this->book->addChapter("Chapter 7.3", "Chapter00730.html", $this->contentStart . "<h2>Chapter 7.3.0</h2>\n" . $chapter7Body, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       
       
       $this->log->logLine("Add Chapter 7.3.1.0");
       $this->book->subLevel();
       $this->book->addChapter("Chapter 7.3.1", "Chapter00731.html", $this->contentStart . "<h2>Chapter 7.3.1</h2>\n" . $chapter7Body, false, EPub::EXTERNAL_REF_ADD, $this->fileDir);
       
       // If you have nested chapters, you can call ->rootLevel() to return your hierarchy to the root of the navMap.
       $this->book->rootLevel();
       
       // $this->log->logLine("Add TOC");
       // $this->book->buildTOC();
       
       $this->book->addChapter("Log", "Log.html", $this->contentStart . $this->log->getLog() . "\n</pre>" . $this->bookEnd);
       
       if ($this->book->isLogging) { // Only used in case we need to debug EPub.php.
           $epuplog = $this->book->getLog();
           $this->book->addChapter("ePubLog", "ePubLog.html", $this->contentStart . $epuplog . "\n</pre>" . $this->bookEnd);
       }
    }
       
    public function outputBook()
    {
       ...
       */
       ...
       //$this->book->saveBook('epub-filename', '.');
       
       // Send the book to the client. ".epub" will be appended if missing.
       $zipData = $this->book->sendBook("ExampleBook1");
       return $zipData;
